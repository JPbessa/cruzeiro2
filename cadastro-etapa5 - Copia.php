			...
			<div class="conteudo">
				...
				if ($resultRow['tipoPagamento'] == PAGAMENTO_BONUS){
					...
					<div class="divSucesso">
						<span class="titSucesso">Parabéns!</span>
						<p>Seu pagamento foi aprovado com sucesso.</p>
						<span class="numPedido">Número do pedido: <?=$resultRow['codVendaFinal']?></span>
						<p>Você receberá futuramente um email com os dados do pedido.</p>	
					</div>
					<?				
				}
				if ($resultRow['tipoPagamento'] == PAGAMENTO_CARTAO){
					...
					<div class="divSucesso">
						...
						<span class="numPedido">Número do pedido: <?=$resultRow['codVendaFinal']?></span>
						<p>Você receberá futuramente um email com os dados do pedido e algumas instruções para proceder o pagamento via vartão de crédito. Aguarde nosso contato.</p>				
					</div>	
					<?	
				}
				...
				enviaEmail(EMAIL_DE, NOME_EMAIL_DE, $resultRow['email'].";".EMAIL_EVENTO.";".USER_EMAIL, "Recebemos seu pedido", $mensagem);	
