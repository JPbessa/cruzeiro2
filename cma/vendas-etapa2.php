<?
	...
	if ($_POST){
		...
		$sql = "INSERT INTO controlecma (
					...
					".$_SESSION['userId'].",
					'".date("Y-m-d H:i:s")."',
					'Cadastro de passageiros da cabine (ID ".$idCabine.")'
				)";					
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt">
    <head>
         <title>Vender: dados dos passageiros | <?=PROJETO?></title>
    ...
    <body class="home">
		...
		<div class="control">				
			...
			<br/>
			<h2 class="titulo1">Informações dos passageiros</h2>
		</div>
					...
					<form id="frmDados" name="frmDados" method="post" action="" >	
						...
						?>
							...
							<legend>Adulto <?=$adulto?></legend>
								...
								<select name="adulto-Sexo[]" class="obrigatorio" style="width:239px;">
						...
						?>
							...
							<legend>Criança <?=$crianca?></legend>
								...
								<select name="crianca-Sexo[]" class="obrigatorio" style="width:239px;">
									<option value="selecione">Selecione</option>
									<option value="m">Masculino</option>
									<option value="f">Feminino</option>								
								</select>
