<? 
	...
	if ($_POST){
		...
		$sql = "INSERT INTO controlecma (
					...
					".$_SESSION['userId'].",
					'".date("Y-m-d H:i:s")."',
					'Liberação da cabine (ID ".$idCabine.") e cancelamento da intenção de pagamento',
					'".utf8_decode($motivo)."'
				)";					
		...
		if ($email <> ""){
			...
			$mensagem = criaEmailLiberar($codVendaFinal, $motivo);
			enviaEmail(EMAIL_DE, utf8_decode(NOME_EMAIL_DE), $email.";".EMAIL_EVENTO.";".USER_EMAIL, "Reserva cancelada", $mensagem);			
		}
	
		finalizaTransacao();
	
		$_SESSION['paginaAnterior'] = "liberar";
		$_SESSION['strErro'] = "";					
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt">
    <head>
        <title>Liberar Cabine | <?=PROJETO?></title>
...
<body>	
	...
	<div class="control">				
		...
		<br/>
		<h2 class="titulo1">Liberar reserva de Cabine</h2>
	</div>
				...
				<div class="boxTabela">		
					...
					<div id="resumoReserva">
						...
						<?
							...
							echo "<br /><strong>Pagamento não registrado.</strong>";
						}
						?>
					</div>
