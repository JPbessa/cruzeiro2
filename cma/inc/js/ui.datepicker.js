...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		monthNames: ['Janeiro','Fevereiro','Março','Abril','Maio','Junho','Julho','Augusto','Setembro','Outubro','Novembro','Dezembro'], // Names of months for drop-down and formatting
		monthNamesShort: ['Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Aug', 'Set', 'Out', 'Nov', 'Dec'], // For formatting
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonText: 'Calendário', // Text for trigger button
