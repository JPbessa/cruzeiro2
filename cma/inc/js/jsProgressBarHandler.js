  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: 'inc/img/barra/percentImage.png',			// boxImage : image around the progress bar
			barImage	: 'inc/img/barra/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
		...
		JS_BRAMUS.jsProgressBar.prototype = {
			 ...
			 */				
				...
				initVisuals		: function () {
					...
					$(this.el).update(
						'<img id="' + this.id + '_percentImage" src="' + this.options.boxImage + '" alt="0%" style="width: ' + this.options.width + 'px; height: ' + this.options.height + 'px; background-position: ' + this.initialPos + 'px 50%; background-image: url(' + this.options.barImage[this.backIndex] + '); padding: 0; margin: 7pt;" class="percentImage" />' + 
